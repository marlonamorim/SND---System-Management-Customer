...
using SND.SystemManagementCustomer.Repository.DependencyInjection;

namespace SND.SystemManagementCustomer.Presentation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<ResellersApi>(Configuration.GetSection("ResellersApi"));
